...
@implementation UIButton (CGXBarButtonImageTitleSpace)
...
- (void)layoutButtonWithEdgeInsetsStyle:(CGXBarButtonEdgeInsetsStyle)style imageTitleSpace:(CGFloat)space {
    ...
    switch (style) {
        case CGXBarButtonEdgeInsetsStyleTop:
        {
            ...
            break;
        case CGXBarButtonEdgeInsetsStyleLeft:
        {
            imageEdgeInsets = UIEdgeInsetsMake(0, -space/2.0, 0, space/2.0);
            labelEdgeInsets = UIEdgeInsetsMake(0, space/2.0, 0, -space/2.0);
        }
            break;
        case CGXBarButtonEdgeInsetsStyleBottom:
        {
            imageEdgeInsets = UIEdgeInsetsMake(0, 0, -labelHeight-space/2.0, -labelWidth);
            labelEdgeInsets = UIEdgeInsetsMake(-imageHeight-space/2.0, -imageWith, 0, 0);
            
        } break;
        case CGXBarButtonEdgeInsetsStyleRight:
        {
